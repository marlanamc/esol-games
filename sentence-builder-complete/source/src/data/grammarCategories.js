...
export const getCategoryByLevel = (levelId) => {
  return grammarCategories.find(cat => cat.levels.includes(levelId))
}

export const getUnlockedCategories = (userPoints) => {
  return grammarCategories.filter(cat => userPoints >= cat.unlockRequirement)
}

export const getCategoryProgress = (categoryId, completedLevels) => {
...
export const getNextRecommendedCategory = (userPoints, completedLevels) => {
